...
<div id="main-wrapper">
  <div id="equal-1" class="width-three">
    ...
    <table style="width:100%;" border="1">
      <tr>
        <td style="width:50%;"><strong>The Griffin 2 Range</strong></td>
        <td style="width:50%;"><strong>The Neo Range</strong></td>
      </tr>
      <tr>
        <td style="width:50%;"><a href="griffin.php"><img class="copier-table" src="images/sharp/griffin2.jpg" alt="thumbnail of the griffin range"></a></td>
        <td style="width:50%;"><a href="neo.php"><img class="copier-table" src="images/sharp/neo.jpg" alt="thumbnail of the neo range"></a></td>
      </tr>
      <tr>
        <td>A range of 4 SRA3 machines with varying speeds from 26 pages per minute up to 40 pages per minute, with plenty of finishing and software options. Very easy to use and super reliable.<br>
          See all of the details <a href="Griffin2.php">here</a>.
        </td>
    ...
    <table style="width:100%;" border="1">
      ...
      <tr>
        <td style="width:50%;"><a href="sphinx.php"><img class="copier-table" src="images/sharp/sphinx.jpg" alt="thumbnail of the sphinx range"></a></td>
        <td style="width:50%;"><a href="polaris.php"><img class="copier-table" src="images/sharp/polaris.jpg" alt="thumbnail of the polaris range"></a></td>
      </tr>
      <tr>
