<?php
$pageTitle="Resources:";
$pageSummary="Welcome to our resources page. Here you will find links and helpful terminology to help you";
...
<div id="main-wrapper">
	<div id="equal-1" class="width-three">
		<div class="main-span">
			<h1>Glossary...</h1>
			<p>We have a glossary of terms located <a href="glossary.php">here</a> that you may find usefull.</p>
		...
		<div class="main-span">
			...
			<p>We have a page <a href="links.php">here</a> that contains links to	manufacturer websites.</p>
			<p>This page has been established to enable our customers to download	drivers, software and manuals direct from manufacturers websites</p>
