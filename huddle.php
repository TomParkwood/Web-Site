...
<div id="main-wrapper">
  <div id="equal-1" class="width-three">
    ...
    <img src="images/Sharp-Huddle.jpg" alt='Sharp Huddle Space' width="50%" height="50%"/>
    ...
    <p>The Huddle Spaces can be equipped with up to 50" BigPad and power and networks points, as well as a Mini-OPS PC which will allow for wireless display connect to the BigPad so there is no need to run cables if not necessary.<br>
      ...
      <table style="width:100%;">
        <tr>
          <td style="width:50%;"><img src="images/sharp/huddle/four-open.jpg" alt="Four seater HuddleSpace with open top"></td>
          <td style="width:50%;"><img src="images/sharp/huddle/four-closed.jpg" alt="Four seater HuddleSpace with closed top"></td>
        </tr>
      </table>
  </div>
  <?php
