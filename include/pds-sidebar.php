...
<div id="equal-4" class="sidebar width-four">
	...
	<?php
		...
		if( $pageName == "drivve.php" )
		{
			echo "<h1>Photocopiers</h1>";
			echo "<p>The Griffin 2 range of photocopiers by Sharp, which go up to 40 pages per minute, so they are perfect for a small to medium office size.<br>With the ability to embed PaperCut directly into the touchscreen makes using Software solutions </p>";
			echo "<p><a href=\"\"></a></p>";
			echo "<div class=\"separator\"></div>";
			echo "<h1>Nursery Table</h1>";
			echo "<p>Sharp's new 40\" Nursery Table.<br>Unlike any other 40\" tablets it runs off of battery power and has a multi-point tiltable screen so children of all heights can use it.</p>";
