...
<div id="equal-4" class="sidebar width-four">
	...
	<?php
		...
		if( $pageName == "contact.php" || $pageName == "general-enquiry-form.php" || $pageName == "meter-reading-form.php" || $pageName == "service-request-form.php")
		{
			...
			echo "<p><a href=\"serviceform.php\">Service Request Form</a></p>";
			echo "<p><a href=\"meterform.php\">Meter Reading Form</a></p>";
			echo "<p><a href=\"enquiryform.php\">General Enquiry Form</a></p>";
			echo "<div class=\"separator\"></div>";
		}
		...
		if($pageName == "printer-repairs.php" )
		{
			echo ""
		}
	?>
